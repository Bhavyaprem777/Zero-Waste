...
const DonorPanel = () => {
  ...
  const handleImageUpload = async (e) => {
    ...
    try {
      ...
      setFoodData((prev) => ({
        ...
        foodImages: [...prev.foodImages, selectedFile], // Storing image in state
      }));
    } catch (error) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-blue-50 py-12 px-6">
      <h1 className="text-3xl font-semibold text-center mb-6 text-indigo-600">🍲 Donor Panel</h1>
      ...
      {!isRegistered && (
        <form onSubmit={handleRegister} className="bg-white shadow-xl rounded-2xl p-8 max-w-xl mx-auto border border-green-100 text-lg">
          <h2 className="text-4xl font-semibold mb-6 text-green-600 text-center">Register as a Donor</h2>
